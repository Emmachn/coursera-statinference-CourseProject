...
The following graph shows how the mean values of 1000 simulations approximate the normal distribution (curve in red).
...
The following plot shows the growth length, per supplement at varying dosages:
```{r, tooth-growth-boxplot}
#plot and customize graph
...
$H_{0}$ : Supplement _OJ (Orange Juice)_ leads to more growth. $\mu$ = 3
...
## Supporting figures and exploratory analysis for Part 2, ToothGrowth data.
